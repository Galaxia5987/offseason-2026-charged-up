...
object Sensors {
    ...
    val IntakeSensor = object : DistanceSensor {
        override val isPresent: Boolean
            get() = IntakeCanRange.isInRange
    }
    val bodySensor = object : DistanceColorSensor {
        override val isPresent: Boolean
            get() = false
    ...
    val DispatchSensor = object : DistanceColorSensor {
        override val isPresent: Boolean
            get() = false
        override val color: CubeColors
            get() = CubeColors.NONE
    ...
    val GripSensor = object : DistanceColorSensor {
        override val isPresent: Boolean
